...
public class LocacaoBuilder {
	...
	public static LocacaoBuilder umLocacaoAtrasado() {
		LocacaoBuilder builder = new LocacaoBuilder();
		inicializarDadosPadroes(builder);
		builder.elemento.setDataLocacao(DataUtils.obterDataComDiferencaDias(-4));
		builder.elemento.setDataRetorno(DataUtils.obterDataComDiferencaDias(-2));
		return builder;
	}
